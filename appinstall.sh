...
echo "install app"
sudo pacman -S  neovim mpv yazi ueberzugpp ffmpeg 7zip jq poppler fd ripgrep fzf zoxide resvg imagemagick unzip nwg-look lxsession imv slock udisks2 trash-cli brightnessctl caja flameshot  
echo "install zsh"
